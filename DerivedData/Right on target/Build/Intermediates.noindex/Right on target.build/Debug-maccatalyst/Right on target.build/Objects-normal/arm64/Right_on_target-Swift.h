...
#ifndef RIGHT_ON_TARGET_SWIFT_H
#define RIGHT_ON_TARGET_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Right_on_target",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15Right_on_target11AppDelegate")
...
SWIFT_CLASS("_TtC15Right_on_target13SceneDelegate")
...
- (void)viewDidLoad;
- (IBAction)buttonChoiceAction:(UIButton * _Nonnull)sender;
...
@property (nonatomic, weak) IBOutlet UISlider * _Null_unspecified mySlider;
